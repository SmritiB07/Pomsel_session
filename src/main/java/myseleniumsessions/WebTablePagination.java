...
public class WebTablePagination {
	...
	public static void selectMultipleNames(String Country) {
		List<WebElement> CountryName=driver.findElements(By.xpath("(//td[text()='"+Country+"'])/preceding-sibling::td/input[@type='checkbox']"));
	...
	public static void selectCity(String value) {
		driver.findElement(By.xpath("//td[text()='"+value+"']/preceding-sibling::td/input[@type='checkbox']")).click();
	}
